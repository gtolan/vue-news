<template>
  <div class="row carousel-wrap">
    ...
    <router-link
      class="waves-effect waves-light btn-large see-more red"
      v-bind:to="activeSlideLink"
      ...
      carousel: [
        {
          id: 1,
          img:
            "https://cdn.shopify.com/s/files/1/0877/2824/files/20181008_MG_1589.jpg?v=1539291947",
          title: "Comfort",
        ...
        },
        {
          id: 2,
          img:
            "https://media.nicershoes.com/wp-content/uploads/2018/01/Best-Shoes-for-Rain.jpeg",
          title: "Rain Ready",
        ...
        },
        {
          id: 4,
          img:
            "http://www.thebearbrighton.co.uk/images/large/fastsole.co.uk/TU%20R17VD7JjihBV6Y8d_LRG.jpg",
          title: "adidas",
          link: "products/all/nike",
